...
pos_format_label = Label(root, text="1. Positives :  ",
                         fg="green", font=("Arial", 10, 'bold')).place(x=200, y=90)
neg_format_label = Label(root, text="2. Negatives ",
                         fg="green", font=("Arial", 10, 'bold')).place(x=200, y=110)
zero_format_label = Label(root, text="3. Zeros  ",
                          fg="green", font=("Arial", 10, 'bold')).place(x=200, y=130)
float_format_label = Label(root, text="4. Floating points/decimals/fractions  ",
                           fg="green", font=("Arial", 10, 'bold')).place(x=200, y=150)

num_entry_label = Label(root, text="Enter a number :",
...
# Uncomment the following line if you have a specific icon to use
